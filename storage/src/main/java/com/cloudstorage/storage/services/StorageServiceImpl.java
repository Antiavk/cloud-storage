...
import com.cloudstorage.storage.exceptions.AuthorizedException;
import com.cloudstorage.storage.exceptions.InputDataException;
import com.cloudstorage.storage.exceptions.ServerError;
import com.cloudstorage.storage.models.File;
import com.cloudstorage.storage.models.FilesTable;
...
public class StorageServiceImpl implements StorageService {
    ...
    public List<File> getFileList(String authToken, int limit) {
        ...
        final List<FilesTable> fileList = filenameRepository.findByDirname(directory, limit);
        ...
        return fileList.stream().<File>map((FilesTable file) ->
                new File(file.getFilename(), file.getSize())).collect(Collectors.toList());
    }
